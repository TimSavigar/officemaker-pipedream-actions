...
export function buildAiLetter({
  ...
  purpose = 'follow up after an event-driven workflow'
} = {}) {
  return {
    type: 'document',
    content: {
      children: [
        ...
        paragraph(`This message is from ${companyName} to ${purpose}.`),
        paragraph('The output was generated through a Pipedream-ready OfficeMaker action.'),
...
export function buildBriefingDeck({
  title = 'OfficeMaker + Pipedream',
  subtitle = 'Event-driven starter example',
  highlights = ['Event sources trigger document creation', 'Minimal HTTP action surface', 'Developer-friendly code-first setup']
} = {}) {
  return {
    type: 'powerpoint',
    slides: [
      ...
      },
      {
        ...
        shapes: [
          { type: 'textBox', shapeName: 'Title 1', text: 'Why Pipedream' },
